  ...
  ">
    ...
    <div className="flex items-center gap-4">
         ...
         <TooltipProvider key={collaborator.id}>
          <Tooltip>
            <TooltipTrigger asChild>
              <Avatar className="-ml-3 bg-background 
              border-2
              flex
              items-center
              justify-center
              ...
              rounded-full
              ">
                <AvatarImage src={collaborator.avatar ? collaborator.avatar : ''}
                className="rounded-full"
                ></AvatarImage>
                <AvatarFallback>
                  {collaborator.email.substring(0).toUpperCase()}
                </AvatarFallback>
              </Avatar>
            </TooltipTrigger>
          </Tooltip>
      ...
      </div>
      {
        saving ? <Badge
        variant="secondary"
        className="bg-orange-600 top-4 text-white 
        right-4 z-50"
        >
          Saving....
        </Badge> : <Badge variant="secondary"
        
        className="bg-emerald-600 top-4 text-white 
        right-4 z-50"
        >
          Saved
        </Badge>
  ...
  details.bannerUrl &&
   (
    <div className="relative w-full h-[200px]">
      <Image src={supabase.storage.from('file-banners')
...
<div className="flex justify-center
    items-center flex-col mt-2 relative
    ">
      <div className="w-full self-center max-w-[800px]
      flex flex-col px-7 lg:my-8
      ">
       <div className="text-[80px]">
        ...
        <div className='flex'>
          ...
          p-2 hover:text-card-foreground transition-all rounded-md"
          >
